...
| Face/plate/document privacy redaction | **OPEN SOURCE** | Mature face/plate detectors exist; **BUILD** is just wiring auto-blur into the upload pipeline, not the detector itself. This should be near-term, not deferred — it's a legal/trust requirement, not a moonshot. |
