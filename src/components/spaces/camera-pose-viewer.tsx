...
//
// `three` + OrbitControls are imported dynamically inside the effect, not
// at module scope — same reasoning and same proven pattern as
// SplatViewer's @mkkellogg/gaussian-splats-3d import. A static top-level
// import here pulled Three.js into this page's bundle graph regardless of
// whether the space being viewed actually had any camera poses yet,
// measured live as ~5s of extra chunk-download time on a freshly
// captured, unprocessed space — the common case, not the exception.
